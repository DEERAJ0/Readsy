...
const BookPage = () => {
    ...
    const {fetchBook,book,deleteBook,isLoading} = useBookStore();
  ...
  return (
    ...
    <div className="flex flex-col md:flex-row">
      <div className="md:basis-[30%] md:mr-6 mx-auto w-full">
        <img src={book?.image} alt="book_image" className="max-h-[50vh] mx-auto"/>

        <Link to={book?.pdf} target="_blank">
        <div className="w-full flex justify-center items-center">
          <button className="bg-[#403d39] text-[#ccc5b9] px-3
          py-2 w-full md:max-w-52 mt-3">Download</button>
        </div>
        </Link>
      ...
      <div className="basis-[65%] mt-6 md:mt-0 md:max-w-4xl">
        <div className="flex justify-between items-center">
          ...
          className="cursor-pointer tracking-widest">...</span>

          {open && <div className="absolute bg-[#f5f5f5] shadow-md pb-2
        ...
        <h1 className="text-4xl md:text-xl lg:text-6xl font-semibold mb-2">{book?.title}</h1>
