...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen text-[#252422] bg-[#f5f5f5] px-4 md:px-12">
      <h2 className="text-center font-semibold pt-8 md:text-2xl w-full max-w-xl mx-auto">SignUp</h2>
      ...
      <form onSubmit={handleSignup} className="flex flex-col justify-center items-center w-full max-w-xl mx-auto space-y-4 mt-10">
        ...
        <p>Already have an account? <Link to={'/login'} className='text-[#944424]'>Login</Link></p>
